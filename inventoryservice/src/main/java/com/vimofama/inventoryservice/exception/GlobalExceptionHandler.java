package com.vimofama.inventoryservice.exception;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<Map<String, Object>> handleHttpMessageNotReadable(HttpMessageNotReadableException ex) {
        ...
        if (detailedMessage != null) {
            if (detailedMessage.contains("int") || detailedMessage.contains("Integer")) {
                message = "El formato de la cantidad no es válido. Debe ser un número entero (ejemplo: 10)";
            } else if (detailedMessage.contains("Long")) {
                message = "El formato del ID del producto no es válido. Debe ser un número entero";
